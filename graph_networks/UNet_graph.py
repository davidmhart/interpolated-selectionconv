...
class _ResBlock(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels):
        ...
        self.conv2 = SelectionConv(middle_channels, middle_channels, kernel_size=3,padding_mode="replicate")
...
class UNet(nn.Module):
    def __init__(self, num_classes, in_channels=3, feat=32):
        ...
        self.start = SelectionConv(in_channels, feat, kernel_size=3,padding_mode="replicate")
        ...
        self.final = SelectionConv(feat, num_classes, kernel_size=3,padding_mode="replicate")
